...
# データベースでのテーブル名の指定
#=================================================================================
define('ACCESS_LOG','ACCESS_LOG_TB');

#=================================================================================
# ファイル接尾語の指定
#=================================================================================
define('FILE_SUFFIX','_access_log_tb_db');
...
define('DB_FILEPATH',ACCESS_PATH.$date_name.FILE_SUFFIX);
...
function access_log_start($filename) {
        $filename = (!$filename)?date('Y_m')."_access_log_tb_db":$filename;
	$SQLITE = new dbOpe("sqlite:".ACCESS_PATH.$filename);
	$sql_chk = "SELECT COUNT(*) AS CNT FROM sqlite_master WHERE TYPE='table' and NAME='ACCESS_LOG_TB';";
