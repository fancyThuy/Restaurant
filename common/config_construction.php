...
// 設定ファイル＆共通ライブラリの読み込み
require_once __DIR__ . "/config.php"; // 共通設定情報

#=================================================================================
# 管理画面に共通して表示させる値
#=================================================================================
define('TITLE', '施工事例の更新'); // Sx系（商品紹介）のタイトル
define('CATE_TITLE', '施工事例カテゴリーの更新'); // Sx系（商品紹介）カテゴリーのタイトル
...
# 最大表示件数の指定
#=================================================================================
define('DISP_MAXROW', 6); // Sx系（商品紹介）の 1ページの最大表示件数

define('DISP_MAXROW_BACK', DBMAX_CNT); // 管理画面での1ページの最大表示件数

#=================================================================================
# データベースでのテーブル名の指定
#=================================================================================
define('S7_PRODUCT_LST', 'S7_2_PRODUCT_LST'); //商品データ
define('S7_CATEGORY_MST', 'S7_CATEGORY_MST'); //カテゴリー

#=================================================================================
# 表画面のフォルダの指定(管理画面のみで使用・プレビュー用)
#=================================================================================
define('PREV_PATH', '../../construction/');

#=================================================================================
# 画像情報の指定
#=================================================================================
// 画像ファイルパス（管理画面のみで使用）
define('IMG_PATH', '../../construction/up_img/');
// 画像枚数
define('IMG_CNT', 4);
// アップロードサイズ上限(MB)
define('MAX_MB', 2);
